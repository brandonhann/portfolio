...
const Projects = () => {
    const projects = [
        ...
        { title: 'Phi Shape Generator', delay: 1200, repoLink: 'https://github.com/brandonhann/phi-geometry-generator', imageLink: '/images/phi.jpg', desc: "This app allows you to generate unique shapes using ϕ (phi) which output many different variations. Built using nextjs." },
    ];
